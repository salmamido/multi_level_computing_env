# -*- coding: utf-8 -*-
"""
Created on Sat Nov 27 18:01:45 2021
...
parameter = {
    ...
    #"user_tr_power": 0.5,  # transmission power of mobile device in W, 500mW
    "user_tr_power": 1.3,  # transmission power of mobile device in W, 1300mW(wu2020)
    #"user_tr_power": 23*10**6,  # transmission power of mobile device in MHZ, 
    ...
    "user_idle_power":.3, #user idle state power in W(wu2020)
    "User_energy_ceof": 1e-25,
    "LAN_latency":.5, #lan delay in ms
    "WAN_latency":30, #Wan delay in ms
    "uav_no":3, #no of uav
    "mec_no":3, #no of MEC
    "user_no":10, #no of users
    "task_no":10, # no of tasks
    #"uav_loc":np.random.randint(50,100,size=[uav_no,2])
